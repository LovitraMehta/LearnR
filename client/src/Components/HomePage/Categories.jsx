...
const Categories = () => {
    ...
    return (
        <div className='py-2'>
            <div className='text-2xl font-medium pb-2 px-4 text-center'>Categories</div>
            <div className='flex justify-center items-center gap-4 overflow-x-auto cursor-pointer px-4'>
                {
