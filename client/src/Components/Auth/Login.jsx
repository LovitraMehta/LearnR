    ...
    <div className='w-full h-screen flex justify-center items-center bg-[#f2f2f2]'>
      ...
      <div className='flex flex-col justify-center items-center px-4 py-5 rounded-[30px] max-w-[300px] sm:max-w-[400px] max-h-[600px] bg-white shadow-lg'>
        <form onSubmit={handleSubmit}>
          ...
          <p className='text-base font-medium mb-4 text-[#727986]'>Enter your details to log into your LearnR Account:</p>
          <div className='flex flex-col mb-4'>
            <label htmlFor='email' className='text-sm font-semibold mb-2.5'>Email*</label>
            <input id='email' name='email' className='border hover:border-[#0090FC] p-2 rounded-[10px] text-sm font-light h-[30px] focus:outline-none' type="text" placeholder='bhavay.kaushal@outlook.com' onChange={(e) => { setEmail(e.target.value) }} />
          </div>
          ...
          <p className='text-xs text-center my-4'>Don't have a LearnR account? <Link to="/signup" className='text-[#0090FC] visited:text-[#0090FC]'>Sign Up</Link></p>
        </form>
      </div>
    </div>
  )
